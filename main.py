...
class Encoder(tf.keras.Model):
    ...
    def call(self, x):  # Change __call__ to call
...
def main():
    ...
    image1 = st.file_uploader(" Upload the front image ", type=["png", "jpg", "jpeg"])
    image2 = st.file_uploader(" Upload the lateral image", type=["png", "jpg", "jpeg"])
    ...
    if st.button(" Generate Captions"):
        if image1 is not None and image2 is not None:
            ...
            st.error("Please upload both images before generating captions.")
